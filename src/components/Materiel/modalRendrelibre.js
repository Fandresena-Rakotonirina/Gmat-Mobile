...
const ModalRendrelibre = ({ visible, hideModal }) => {
    ...
    return (
        <Portal>
            <Modal visible={visible} onDismiss={hideModal} contentContainerStyle={containerStyle}>
                ...
                <Text style={{ fontSize: 18, marginBottom: 10, textAlign: 'center' }}>Voulez-vous rendre libre ce matériel ?</Text>
                <Divider style={styles.divider} />
...
export default ModalRendrelibre;
